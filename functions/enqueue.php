...
function dcaste_wp_starter_add_editor_styles() {
	add_editor_style( get_template_directory_uri() . '/assets/css/styles.min.css' );
}

// Enqueue JS scripts (vendors and custom)
function dcaste_wp_starter_scripts() {
	wp_enqueue_script( 'dcaste_wp_starter-vendors', get_template_directory_uri() . '/assets/js/vendors.min.js', array(), '1.0.0', 'all' );
