...
module.exports = {
	// Project options.
	projectURL: "http://localhost/dcaste_wp_starter/", // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	productURL: "./", // Theme/Plugin URL. Leave it like it is, since our gulpfile.js lives in the root folder.
	browserAutoOpen: true,
	injectChanges: true,

	// Style options.
	styleSRC: "./src/sass/styles.scss", // Path to main .scss file.
